...
let CarReportPage = class CarReportPage {
    constructor(router, activatedRoute, gpsService, nativeGeocoder, modalController) {
        ...
        this.dataListDevice = [];
        /* eslint-disable */ console.log(...oo_oo(`3000363565_47_4_47_64_4`, this.router.getCurrentNavigation().extras.state));
    }
    ngOnInit() {
        this.getEventData();
    }
    getEventData() {
        ...
        this.gpsService.
            ...
            parserInformation.parseString(resEventData.data, (err, result) => {
                ...
                /* eslint-disable */ console.log(...oo_oo(`3000363565_95_10_95_47_4`, 'Event data information'));
                /* eslint-disable */ console.log(...oo_oo(`3000363565_96_10_96_48_4`, this.eventDataInformation));
