...
@Component({
  ...
  templateUrl: './list-car-actions.page.html',
  styleUrls: ['./list-car-actions.page.scss'],
})
export class ListCarActionsPage implements OnInit {
